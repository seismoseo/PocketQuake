...
\begin{enumerate}
  \item scaffolds a cluster dir under
        \texttt{external/korea-cluster-relocation/chungju\_smoke\_cluster/}
...
\begin{center}
\includegraphics[width=0.85\textwidth,height=0.72\textheight,keepaspectratio]{figures/03_depth_sections.png}
\end{center}
\vspace{-0.5em}
\scriptsize
...
\includegraphics[width=\textwidth,height=0.7\textheight,keepaspectratio]{figures/04_beachball_gallery.png}
\column{0.48\textwidth}
\includegraphics[width=\textwidth,height=0.7\textheight,keepaspectratio]{figures/06_record_section_M31.png}
\end{columns}
\vspace{0.5em}
\scriptsize
...
\smallskip
\textit{Made by seismoseo / SGTL, SNU.}
\end{frame}
