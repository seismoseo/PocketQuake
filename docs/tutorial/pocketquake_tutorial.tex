...
\end{description}
\smallskip
\textbf{Velocity model:} located with both kim1983 + kim2011; relocation + notebook use
\textbf{kim1983} by default. To relocate with kim2011, call the eq-cycle CLI directly:
\texttt{python -m pipeline.cli.run\_pipeline -{}-cluster <slug> -{}-through dtcc -{}-arc-velmodel kim2011}.
\end{frame}
